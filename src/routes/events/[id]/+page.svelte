			...
			<div class="flex items-center gap-2">
				...
				{#if data.user && data.user.role !== 'creator'}
					<button
						...
						class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border transition-colors text-sm {$eventFavorites.includes(data.event.id) ? 'border-red-300 bg-red-50 text-red-600 hover:bg-red-100' : 'border-input hover:bg-primary hover:text-white hover:border-primary text-muted-foreground'}"
					>
